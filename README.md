...
| `SSL_TOS`      | `REJECT` , `ACCEPT`               | `REJECT`   | Indicates your acceptance of the T&S's for the SSL certificate set forth at <https://letsencrypt.org/repository/#let-s-encrypt-subscriber-agreement>. You MUST set this to `ACCEPT` for LetsEncrypt to issue you with SSL certificates! |
